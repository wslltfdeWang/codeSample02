var dic = require("../../../../utils/dic.js"), 
    ...
    API_comNeedInfo_save = require("../../../../utils/config.js").API_comNeedInfo_save,
...
Page({
  ...
  data: {
    itemMap:{
       ...
       companyUsage:'用途',
       companyName:'公司名字',
       mortgageThings:'是否具有抵押物资'
    }
  },
  onLoad: function(e) {
        if (util.getValueArray({
            companyUsage:dic.companyUsage,
            mortgageThings:dic.mortgageThings
        })); 
    },
    ...
    if (util.checkRequired(e, self.data.itemMap)){
        app.getUserOpenId(function(err,openid){
          if (!err) {
             ...
             data.companyUsageKey = self.data.companyUsageKey;
             data.mortgageThingsKey = self.data.mortgageThingsKey;
             data.openId = openid;
             wx.request({  
                url: API_comNeedInfo_save,  
                data: data,  
                method: 'POST',  
                header: {
