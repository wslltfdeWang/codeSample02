...
Page({
  onShareAppMessage() {
    return {
      title: '保险方案设计',
      path: 'page/home/pages/info-insurance/info-insurance'
    }
  },
  data: {
  },
        ...
        app.getUserOpenId(function (err, openid) {
            if (!err) {
              wx.showLoading({
                ...
                data.reportType = '2'; //0:贷款方案；1：政府贴息；2：保险业务
                data.customerType='0'; //用户类型（0：不区分，1：个人用户，2：企业用户）
                data.dealType='3'; //0:立即办理，1：人工方案,2:预约咨询,3:方案定制预约（针对保险）
                wx.request({
                    ...
                    success: function (res) {
                        ...
                        if (res.data.code == 0) {
                            ...
                            wx.navigateTo({
                                url: '../loan-result/loan-result?dealType=3'
                            })
